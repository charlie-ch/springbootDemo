...
//        shiroFilterFactoryBean.setFilters(filters);
        ...
        filterChainDefinitionManager.put("/logout", "logout");//注销,访问此路径，可直接注销，不用手动写控制方法
        filterChainDefinitionManager.put("/user/**", "authc,roles[user]");
        filterChainDefinitionManager.put("/shop/**", "authc,roles[shop]");
        filterChainDefinitionManager.put("/admin/**", "authc,roles[admin]");
        filterChainDefinitionManager.put("/unauthorized", "authc");//无权限提示信息
        filterChainDefinitionManager.put("/login", "anon");//anon 可以理解为不拦截
        filterChainDefinitionManager.put("/login1.html", "anon");//anon 可以理解为不拦截
        ...
        shiroFilterFactoryBean.setSuccessUrl("/");//登录成功
        shiroFilterFactoryBean.setUnauthorizedUrl("/unauthorized");//权限不足
